...
main = do
  ...
  xmonad $ fullscreenSupport $ docks $ ewmh (defaults xmproc)
...
defaults xmproc = def {
      ...
      -- hooks, layouts
        ...
        layoutHook = myLayout,
        --layoutHook = gaps [(L,30), (R,30), (U,30), (D,60)] $ spacingRaw True (Border 10 10 10 10) False (Border 10 10 10 10) False $ smartBorders $ myLayout,
